...
app.config['MYSQL_DATABASE_PASSWORD'] = 'Mesutal_1'
...
def find_records():
    if request.method == 'POST':
        ...
        return render_template('index.html', persons_html=persons_app, keyword=keyword, show_result=True, developer_name='Mesut')
    else:
...
def add_record():
    if request.method == 'POST':
        ...
        return render_template('add-update.html', show_result=True, result_html=result_app, not_valid=False, action_name='save', developer_name='Mesut') #In addition, There is no message shown by user here. Thats why not valid is going to be False.
    else:
...
def update_record():
    if request.method == 'POST':
        ...
        return render_template('add-update.html', show_result=True, result_html=result_app, not_valid=False, action_name='update', developer_name='Mesut') #Again, There is no message shown by user here. Thats why not valid is going to be False.
    else:
...
def delete_record():
    if request.method == 'POST':
        ...
        return render_template('delete.html', show_result=True, result_html=result_app, not_valid=False, developer_name='Mesut') # In addition, There will be no message to be shown to the user here. Thats why not valid is going to be False.
    else:
